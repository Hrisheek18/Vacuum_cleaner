...
# Start PWM with default 50% duty cycle
for pwm in [pwm_rf, pwm_rr, pwm_lf, pwm_lr]:
    pwm.start(50)

# Map motor IDs to pins
MOTORS = {
...
TRIG_RIGHT, ECHO_RIGHT = 16, 25  # (Changed right ECHO to avoid PWM pin conflict)
...
try:
    print("Autonomous bot started... Press CTRL+C to stop")
    ...
    while True:
        ...
        print(f"Front: {front:.1f} cm | Left: {left:.1f} cm | Right: {right:.1f} cm")
    ...
    print("Keyboard Interrupt. Stopping bot...")
